...
> [!TIP]
> * 支持通过 **Yaml 源文件**添加 Twitch 直播源与 VOD，详见[开发者选项](../Config/developerOptions.html)。
> * 推荐使用 `streamlink` 下载器以获得更好兼容性，需先完成 [FFmpeg 安装](../../docs/ffmpeg安装.html)。

----

## 登录信息

* 配置 Twitch 登录信息后，可解锁更高画质并提升录制稳定性。请在[登录方式详解](../introduce/login.html)中配置对应账号，并在主播编辑页关联。
